...
**/
	...
	define('M4J_LANG_ONLYPRO','Apenas para a versão PRO!');
	define('M4J_LANG_ONLYPRO_DESC','<span style=\'color:red; font-weight:bold\'>Esta função só está disponível para a versão PRO!</span>');
	define('M4J_LANG_ONLYONETEMPLATE','A versão básica permite atribuir apenas um modelo de formulário. <br> Na versão PRO você pode compilar um formulário de vários modelos!');
