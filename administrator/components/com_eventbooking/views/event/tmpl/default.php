...
<?php
	...
	echo $this->tabs->startPanel(JText::_('EB_BASIC_INFORMATION'),'general-page');
?>	
	...
	<fieldset class="adminform">
		...
		<table class="admintable" width="100%">
			...
			<tr>
				...
				<td>					
					<?php echo JHTML::_('calendar', ($this->item->event_date == $this->nullDate) ? '' : JHTML::_('date', $this->item->event_date, $format, $param), 'event_date', 'event_date') ; ?>
			...
			<tr>
				...
				<td>					
					<?php echo JHTML::_('calendar', ($this->item->event_end_date == $this->nullDate) ? '' : JHTML::_('date', $this->item->event_end_date, $format, $param), 'event_end_date', 'event_end_date') ; ?>
			...
			<tr>
				...
				<td>
					<?php echo JHTML::_('calendar', ($this->item->cut_off_date == $this->nullDate) ? '' : JHTML::_('date', $this->item->cut_off_date, $format, $param), 'cut_off_date', 'cut_off_date') ; ?>
				</td>
			</tr>
			<tr>
				<td class="key">
...
<div class="col width-40" style="float:left; display: inline;">
	<fieldset>
		...
		<table class="adminlist" id="price_list">
			...
			<?php
				...
				?>
					<tr>
						<td>
							<input type="text" class="inputbox" name="registrant_number[]" size="10" value="<?php echo $registrantNumber; ?>" />
						</td>						
						<td>
							<input type="text" class="inputbox" name="price[]" size="10" value="<?php echo $price; ?>" />
						</td>
					</tr>
				<?php				 									
				}
...
<?php
	...
	?>
		<div class="col width-40" style="float:left; display: inline;">
			<fieldset class="eb_recurring_setting">
				...
				<table class="adminlist">
					<tr>
						...
						<td>					
							<table width="100%">
								...
								<tr>
									<td>
										<input type="radio" name="recurring_type" value="1" <?php if ($this->item->recurring_type == 1) echo ' checked="checked" ' ; ?> onclick="setDefaultData();" /> <?php echo JText::_('EB_REPEAT_EVERY'); ?> <input type="text" name="number_days" size="5" class="inputbox" value="<?php echo $this->item->number_days ; ?>" /> <?php echo JText::_('EB_DAYS'); ?>				
									</td>
								</tr>
								<tr>
									<td>
    										<input type="radio" name="recurring_type" value="2" <?php if ($this->item->recurring_type == 2) echo ' checked="checked" ' ; ?> onclick="setDefaultData();" /> <?php echo JText::_('EB_REPEAT_EVERY'); ?> <input type="text" name="number_weeks" size="5" class="inputbox" value="<?php echo $this->item->number_weeks ; ?>" /> <?php echo JText::_('EB_WEEKS'); ?>
    										<br />
								...
								<tr>
									<td>
										<input type="radio" name="recurring_type" value="3" <?php if ($this->item->recurring_type == 3) echo ' checked="checked" ' ; ?> onclick="setDefaultData();" /> <?php echo JText::_('EB_REPEAT_EVERY'); ?> <input type="text" name="number_months" size="5" class="inputbox" value="<?php echo $this->item->number_months ; ?>" /> <?php echo JText::_('EB_MONTHS'); ?>																								
								        <?php echo JText::_('EB_ON'); ?> <input type="text" name="monthdays" class="inputbox" size="10" value="<?php echo $this->item->monthdays; ?>" />
									</td>
								</tr>
							</table>																																										
						</td>
					...
					<tr>
						...
						<td>							
							...
							<br />							
							<input type="radio" name="repeat_until" value="2" <?php if (($this->item->recurring_end_date != '') && ($this->item->recurring_end_date != '0000-00-00 00:00:00')) echo ' checked="checked"' ; ?> /> <?php echo JText::_('EB_AFTER_DATE') ?> <?php echo JHTML::_('calendar', $this->item->recurring_end_date != '0000-00-00 00:00:00' ? JHTML::_('date', $this->item->recurring_end_date, $format, $param) : '', 'recurring_end_date', 'recurring_end_date'); ?>														
							<br />
						</td>
					</tr>	
					<?php
...
<?php
	...
	echo $this->tabs->startPanel(JText::_('EB_DISCOUNT_SETTING'),'payment-page');
?>
	<table class="admintable">
		<tr>
			<td class="key" width="30%">
		...
		<tr>
			...
			<td>				
				<?php echo JHTML::_('calendar', $this->item->early_bird_discount_date != $this->nullDate ? JHTML::_('date', $this->item->early_bird_discount_date, $format, $param) : '', 'early_bird_discount_date', 'early_bird_discount_date'); ?>
			</td>
		</tr>
	</table>
<?php	
	echo $this->tabs->endPanel();
	echo $this->tabs->startPanel(JText::_('EB_BILLING_FIELDS_SETTING'),'payment-page');
?>
	<table class="admintable">
		<tr>
...
<?php	
	...
	if ($this->config->event_custom_field) {
		echo $this->tabs->startPanel(JText::_('EB_EXTRA_INFORMATION'));		
		$output = $this->fields->render('params') ;
		echo $output ;
		echo $this->tabs->endPanel();
	}						
	echo $this->tabs->startPanel(JText::_('EB_ADVANCED_SETTINGS'),'advance-settings-page');
	?>
	<table class="admintable">
		<tr>
