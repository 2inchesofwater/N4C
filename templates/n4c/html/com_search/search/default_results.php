...
<dl class="search-results<?php echo $this->pageclass_sfx; ?>">
  <?php foreach($this->results as $result) : ?>
      <dt class="result-index"><<?php echo $this->pagination->limitstart + $result->count.'. ';?> </dt>
      ...
      <?php if ($result->section) : ?>
        <dd class="result-category <?php echo $this->pageclass_sfx; ?>"><?php echo $this->escape($result->section); ?></dd>
      <?php endif; ?>
