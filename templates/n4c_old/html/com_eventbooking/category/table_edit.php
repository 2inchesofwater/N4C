	...
	<table width="100%" class="doc_list">
		...
		<?php
			...
			<section class="blockContainer">
				<li>
					<div class="pin"><img src="./images/pins/pin-yellow.png" alt="ping" /></div>
					<div class="details">
						<a><h3><?php echo $item->title ; ?></h3></a>
						<p class="location"><?php echo $item->location_name ; ?></p>
						<p>[Need to put intro text here]</p>
					</div>
					<div class="datetime">
						<?php $datetime = explode(' ',$item->event_date); ?>
						<p class="date"><?php echo $datetime[0]; ?></p>
						<p class="time"><?php echo $datetime[1]; ?></p>
					</div>
					<a class="button right" href="<?php echo JRoute::_('index.php?option=com_eventbooking&task=view_event&event_id='.$item->id) ?>">More info + RSVP</a>
				</li>
			</section>
