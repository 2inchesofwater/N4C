...
if (file_exists(JPATH_ROOT.DS.'components'.DS.'com_eventbooking'.DS.'helper'.DS.'helper.php')) {
	...
	require_once JPATH_ROOT.DS.'components'.DS.'com_eventbooking'.DS.'helper'.DS.'os_cart.php';
	EventBookingHelper::loadLanguage();
	$Itemid = (int) $params->get('item_id');
	if (!$Itemid)	
	    $Itemid = EventBookingHelper::getItemid();
	$currencySymbol = EventBookingHelper::getConfigValue('currency_symbol');
	$cart = new EBCart();
	$items = $cart->getItems();
